...
# copying prepare.sh over to this file to refactor to avoid pre-built EXEs

# seems DLSS enabler is partially closed source, and Optiscaler is generally better to be used stand alone at this point?
